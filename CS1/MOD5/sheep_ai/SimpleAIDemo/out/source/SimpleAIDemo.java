...
public class SimpleAIDemo extends PApplet {
...
It introduces while loops and arrays.
...
public void drawRings(int x, int y, int radiusChange, 
               int[] colors, int startIndex)
{
  float[] corners = {
...
public void moveSheep()
{
  ...
  if (sheepState == sheepStateWander)
  {
    int nextX = sheepX + PApplet.parseInt(sheepSpeed * cos(sheepDirection));
    int nextY = sheepY + PApplet.parseInt(sheepSpeed * sin(sheepDirection));
...
public void keyPressed()
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "SimpleAIDemo" };
    if (passedArgs != null) {
